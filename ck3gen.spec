...
a = Analysis(
    ...
    datas=[
        ...
        ('config/initialization.json', 'config'),
        ('config/life_stages.json', 'config'),
        ('config/skills_and_traits.json', 'config'),
        ('config/fallback_config_files/initialization.json', 'config/fallback_config_files'),
        ('config/fallback_config_files/life_stages.json', 'config/fallback_config_files'),
        ('config/fallback_config_files/skills_and_traits.json', 'config/fallback_config_files'),
        *streamlit_data[0],
        *matplotlib_data[0],
        *graphviz_data[0],
    ],
